...
public class CountryDto   {
  ...
  */
  ...
  @Schema(name = "email", description = "Email Address to send photos to", required = false)
  ...
  */
  ...
  @Schema(name = "twitterTags", description = "Twitter Tags when sharing the photo on Twitter", required = false)
  ...
  */
  @Valid 
  @Schema(name = "providerApps", description = "array with links to provider apps", required = false)
